...
namespace WebApp.Extensions {
    public class TagHelperExtension {
        ...
        public class SupressElementByClaimTagHelper : TagHelper {
            ...
            public SupressElementByClaimTagHelper (IHttpContextAccessor contextAcessor) {
            ...
            public override void Process (TagHelperContext context, TagHelperOutput output) {
                ...
                var temAcesso = CustomAuthorization.ValidaClaimsUsuario (_contextAcessor.HttpContext, IdentityClaimName, IdentityClaimValue);
        ...
        [HtmlTargetElement ("*", Attributes = "hide-by-action")]
        public class HideElementByActionTagHelper : TagHelper {

            private readonly IHttpContextAccessor _contextAcessor;

            public HideElementByActionTagHelper (IHttpContextAccessor contextAcessor) {
                _contextAcessor = contextAcessor;

            }

            [HtmlAttributeName ("hide-by-action")]
